...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "bsds.correspond_pixels",
        "sources": [
            "bsds/correspond_pixels.pyx",
            "src/csa.cc",
            "src/Exception.cc",
            "src/kofn.cc",
            "src/match.cc",
    ...
    "module_name": "bsds.correspond_pixels"
}
END: Cython Metadata */
...
#define __PYX_HAVE__bsds__correspond_pixels
#define __PYX_HAVE_API__bsds__correspond_pixels
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'bsds.correspond_pixels' */
...
static PyObject *__pyx_f_4bsds_17correspond_pixels__correspond_pixels(__Pyx_memviewslice, __Pyx_memviewslice, double, double, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "bsds.correspond_pixels"
extern int __pyx_module_is_main_bsds__correspond_pixels;
int __pyx_module_is_main_bsds__correspond_pixels = 0;

/* Implementation of 'bsds.correspond_pixels' */
...
static const char __pyx_k_T[] = "T{";
  ...
  static const char __pyx_k_o0[] = "o0";
...
static const char __pyx_k_img0[] = "img0";
...
static const char __pyx_k_outlier_cost[] = "outlier_cost";
...
static const char __pyx_k_correspond_pixels[] = "correspond_pixels";
...
static const char __pyx_k_bsds_correspond_pixels[] = "bsds.correspond_pixels";
static const char __pyx_k_MemoryView_of_r_at_0x_x[] = "<MemoryView of %r at 0x%x>";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_max_dist_must_be_0_it_is[] = "max_dist must be >= 0 (it is {})";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_bsds_correspond_pixels_pyx[] = "bsds/correspond_pixels.pyx";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_outlier_cost_must_be_1_it_is[] = "outlier_cost must be > 1 (it is {})";
...
static const char __pyx_k_img0_shape_and_img1_shape_do_not[] = "img0.shape ({}) and img1.shape({}) do not match";
...
static PyObject *__pyx_n_s_bsds_correspond_pixels;
static PyObject *__pyx_kp_s_bsds_correspond_pixels_pyx;
...
static PyObject *__pyx_n_s_correspond_pixels;
...
static PyObject *__pyx_n_s_img0;
static PyObject *__pyx_kp_s_img0_shape_and_img1_shape_do_not;
...
static PyObject *__pyx_kp_s_max_dist_must_be_0_it_is;
...
static PyObject *__pyx_n_s_o0;
static PyObject *__pyx_n_s_o1;
static PyObject *__pyx_n_s_obj;
static PyObject *__pyx_n_s_oc;
static PyObject *__pyx_n_s_order;
static PyObject *__pyx_n_s_outlier_cost;
static PyObject *__pyx_kp_s_outlier_cost_must_be_1_it_is;
...
static PyObject *__pyx_pf_4bsds_17correspond_pixels_correspond_pixels(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_img0, PyObject *__pyx_v_img1, PyObject *__pyx_v_max_dist, PyObject *__pyx_v_outlier_cost); /* proto */
...
static PyObject *__pyx_f_4bsds_17correspond_pixels__correspond_pixels(__Pyx_memviewslice __pyx_v_img0, __Pyx_memviewslice __pyx_v_img1, double __pyx_v_max_dist, double __pyx_v_outlier_cost, __Pyx_memviewslice __pyx_v_out0, __Pyx_memviewslice __pyx_v_out1) {
  int __pyx_v_rows;
  int __pyx_v_cols;
  double __pyx_v_idiag;
  double __pyx_v_oc;
  Matrix __pyx_v_i0;
  Matrix __pyx_v_i1;
  __Pyx_memviewslice __pyx_v_i0_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_i1_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  Matrix __pyx_v_m0;
  Matrix __pyx_v_m1;
  double __pyx_v_cost;
  __Pyx_memviewslice __pyx_v_o0_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_o1_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("_correspond_pixels", 0);

  /* "bsds/correspond_pixels.pyx":25
 * cdef _correspond_pixels(double[::1,:] img0, double[::1,:] img1, double max_dist, double outlier_cost,
 *                         double[::1,:] out0, double[::1,:] out1):
 *     cdef int rows = img0.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_rows = (__pyx_v_img0.shape[0]);

  /* "bsds/correspond_pixels.pyx":26
 *                         double[::1,:] out0, double[::1,:] out1):
 *     cdef int rows = img0.shape[0]
 *     cdef int cols = img0.shape[1]             # <<<<<<<<<<<<<<
 *     cdef double idiag = math.sqrt(rows * rows + cols * cols)
 ...
 */
  __pyx_v_cols = (__pyx_v_img0.shape[1]);

  /* "bsds/correspond_pixels.pyx":27
 *     cdef int rows = img0.shape[0]
 *     cdef int cols = img0.shape[1]
 *     cdef double idiag = math.sqrt(rows * rows + cols * cols)             # <<<<<<<<<<<<<<
 *     cdef double oc = outlier_cost * max_dist * idiag
 * 
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_math); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(((__pyx_v_rows * __pyx_v_rows) + (__pyx_v_cols * __pyx_v_cols))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __pyx_v_idiag = __pyx_t_6;

  /* "bsds/correspond_pixels.pyx":28
 *     cdef int cols = img0.shape[1]
 *     cdef double idiag = math.sqrt(rows * rows + cols * cols)
 *     cdef double oc = outlier_cost * max_dist * idiag             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_oc = ((__pyx_v_outlier_cost * __pyx_v_max_dist) * __pyx_v_idiag);

  /* "bsds/correspond_pixels.pyx":34
 ...
 */
  try {
    __pyx_t_7 = Matrix(__pyx_v_rows, __pyx_v_cols);
  } catch(...) {
    __Pyx_CppExn2PyErr();
 ...
 *     i0_view[:,:] = img0[:,:]
 */
  __pyx_t_8 = __pyx_v_i0.data();
  if (unlikely(!__pyx_v_img0.memview)) { __Pyx_RaiseUnboundLocalError("img0"); __PYX_ERR(0, 36, __pyx_L1_error) }
  if (unlikely(!__pyx_v_img0.memview)) { __Pyx_RaiseUnboundLocalError("img0"); __PYX_ERR(0, 36, __pyx_L1_error) }
  if (!__pyx_t_8) {
  ...
  __pyx_t_1 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)(__pyx_v_img0.shape[0])), ((Py_ssize_t)(__pyx_v_img0.shape[1])));
  if (unlikely(!__pyx_t_3 || !__pyx_t_1 || !PyBytes_AsString(__pyx_t_3))) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_9 = __pyx_array_new(__pyx_t_1, sizeof(double), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_t_8);
  if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dcd__double(((PyObject *)__pyx_t_9), PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_9)); __pyx_t_9 = 0;
  __pyx_v_i0_view = __pyx_t_10;
  __pyx_t_10.memview = NULL;
  __pyx_t_10.data = NULL;

  /* "bsds/correspond_pixels.pyx":37
 *     cdef Matrix i1 = Matrix(rows, cols)
 *     cdef double[::1,:] i0_view = <double[:img0.shape[0]:1,:img0.shape[1]]>i0.data()
 *     cdef double[::1,:] i1_view = <double[:img1.shape[0]:1,:img1.shape[1]]>i1.data()             # <<<<<<<<<<<<<<
 *     i0_view[:,:] = img0[:,:]
 *     i1_view[:,:] = img1[:,:]
 */
  __pyx_t_8 = __pyx_v_i1.data();
  if (unlikely(!__pyx_v_img1.memview)) { __Pyx_RaiseUnboundLocalError("img1"); __PYX_ERR(0, 37, __pyx_L1_error) }
  if (unlikely(!__pyx_v_img1.memview)) { __Pyx_RaiseUnboundLocalError("img1"); __PYX_ERR(0, 37, __pyx_L1_error) }
  if (!__pyx_t_8) {
    PyErr_SetString(PyExc_ValueError,"Cannot create cython.array from NULL pointer");
  ...
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)(__pyx_v_img1.shape[0])), ((Py_ssize_t)(__pyx_v_img1.shape[1])));
  if (unlikely(!__pyx_t_1 || !__pyx_t_3 || !PyBytes_AsString(__pyx_t_1))) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_9 = __pyx_array_new(__pyx_t_3, sizeof(double), PyBytes_AS_STRING(__pyx_t_1), (char *) "fortran", (char *) __pyx_t_8);
  if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dcd__double(((PyObject *)__pyx_t_9), PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_9)); __pyx_t_9 = 0;
  __pyx_v_i1_view = __pyx_t_10;
  __pyx_t_10.memview = NULL;
  __pyx_t_10.data = NULL;

  /* "bsds/correspond_pixels.pyx":38
 *     cdef double[::1,:] i0_view = <double[:img0.shape[0]:1,:img0.shape[1]]>i0.data()
 *     cdef double[::1,:] i1_view = <double[:img1.shape[0]:1,:img1.shape[1]]>i1.data()
 *     i0_view[:,:] = img0[:,:]             # <<<<<<<<<<<<<<
 *     i1_view[:,:] = img1[:,:]
 * 
 */
  if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_img0, __pyx_v_i0_view, 2, 2, 0) < 0)) __PYX_ERR(0, 38, __pyx_L1_error)

  /* "bsds/correspond_pixels.pyx":39
 *     cdef double[::1,:] i1_view = <double[:img1.shape[0]:1,:img1.shape[1]]>i1.data()
 *     i0_view[:,:] = img0[:,:]
 *     i1_view[:,:] = img1[:,:]             # <<<<<<<<<<<<<<
 * 
 *     # Output matrices
 */
  if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_img1, __pyx_v_i1_view, 2, 2, 0) < 0)) __PYX_ERR(0, 39, __pyx_L1_error)

  /* "bsds/correspond_pixels.pyx":45
 * 
 *     # Perform the match
 ...
 */
  __pyx_v_cost = matchEdgeMaps(__pyx_v_i0, __pyx_v_i1, (__pyx_v_max_dist * __pyx_v_idiag), __pyx_v_oc, __pyx_v_m0, __pyx_v_m1);

  /* "bsds/correspond_pixels.pyx":48
 * 
 *     # Get views of the output matrices and copy to our output arrays
 ...
 *     out0[:,:] = o0_view[:,:]
 */
  __pyx_t_8 = __pyx_v_m0.data();
  if (unlikely(!__pyx_v_out0.memview)) { __Pyx_RaiseUnboundLocalError("out0"); __PYX_ERR(0, 48, __pyx_L1_error) }
  if (unlikely(!__pyx_v_out0.memview)) { __Pyx_RaiseUnboundLocalError("out0"); __PYX_ERR(0, 48, __pyx_L1_error) }
  if (!__pyx_t_8) {
    PyErr_SetString(PyExc_ValueError,"Cannot create cython.array from NULL pointer");
  ...
  __pyx_t_3 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double);
  __pyx_t_1 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)(__pyx_v_out0.shape[0])), ((Py_ssize_t)(__pyx_v_out0.shape[1])));
  if (unlikely(!__pyx_t_3 || !__pyx_t_1 || !PyBytes_AsString(__pyx_t_3))) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_9 = __pyx_array_new(__pyx_t_1, sizeof(double), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_t_8);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dcd__double(((PyObject *)__pyx_t_9), PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_9)); __pyx_t_9 = 0;
  __pyx_v_o0_view = __pyx_t_10;
  __pyx_t_10.memview = NULL;
  __pyx_t_10.data = NULL;

  /* "bsds/correspond_pixels.pyx":49
 *     # Get views of the output matrices and copy to our output arrays
 *     cdef double[::1,:] o0_view = <double[:out0.shape[0]:1,:out0.shape[1]]>m0.data()
 *     cdef double[::1,:] o1_view = <double[:out1.shape[0]:1,:out1.shape[1]]>m1.data()             # <<<<<<<<<<<<<<
 *     out0[:,:] = o0_view[:,:]
 *     out1[:,:] = o1_view[:,:]
 */
  __pyx_t_8 = __pyx_v_m1.data();
  if (unlikely(!__pyx_v_out1.memview)) { __Pyx_RaiseUnboundLocalError("out1"); __PYX_ERR(0, 49, __pyx_L1_error) }
  if (unlikely(!__pyx_v_out1.memview)) { __Pyx_RaiseUnboundLocalError("out1"); __PYX_ERR(0, 49, __pyx_L1_error) }
  if (!__pyx_t_8) {
    PyErr_SetString(PyExc_ValueError,"Cannot create cython.array from NULL pointer");
  ...
  __pyx_t_1 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double);
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)(__pyx_v_out1.shape[0])), ((Py_ssize_t)(__pyx_v_out1.shape[1])));
  if (unlikely(!__pyx_t_1 || !__pyx_t_3 || !PyBytes_AsString(__pyx_t_1))) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_9 = __pyx_array_new(__pyx_t_3, sizeof(double), PyBytes_AS_STRING(__pyx_t_1), (char *) "fortran", (char *) __pyx_t_8);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dcd__double(((PyObject *)__pyx_t_9), PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_9)); __pyx_t_9 = 0;
  __pyx_v_o1_view = __pyx_t_10;
  __pyx_t_10.memview = NULL;
  __pyx_t_10.data = NULL;

  /* "bsds/correspond_pixels.pyx":50
 *     cdef double[::1,:] o0_view = <double[:out0.shape[0]:1,:out0.shape[1]]>m0.data()
 *     cdef double[::1,:] o1_view = <double[:out1.shape[0]:1,:out1.shape[1]]>m1.data()
 *     out0[:,:] = o0_view[:,:]             # <<<<<<<<<<<<<<
 *     out1[:,:] = o1_view[:,:]
 * 
 */
  if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_o0_view, __pyx_v_out0, 2, 2, 0) < 0)) __PYX_ERR(0, 50, __pyx_L1_error)

  /* "bsds/correspond_pixels.pyx":51
 *     cdef double[::1,:] o1_view = <double[:out1.shape[0]:1,:out1.shape[1]]>m1.data()
 *     out0[:,:] = o0_view[:,:]
 *     out1[:,:] = o1_view[:,:]             # <<<<<<<<<<<<<<
 * 
 *     return cost, oc
 */
  if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_o1_view, __pyx_v_out1, 2, 2, 0) < 0)) __PYX_ERR(0, 51, __pyx_L1_error)

  /* "bsds/correspond_pixels.pyx":53
 *     out1[:,:] = o1_view[:,:]
 * 
 *     return cost, oc             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_cost); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_oc); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __Pyx_AddTraceback("bsds.correspond_pixels._correspond_pixels", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_i0_view, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_i1_view, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_o0_view, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_o1_view, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "bsds/correspond_pixels.pyx":56
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_4bsds_17correspond_pixels_1correspond_pixels(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4bsds_17correspond_pixels_1correspond_pixels = {"correspond_pixels", (PyCFunction)__pyx_pw_4bsds_17correspond_pixels_1correspond_pixels, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4bsds_17correspond_pixels_1correspond_pixels(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_img0 = 0;
  PyObject *__pyx_v_img1 = 0;
  PyObject *__pyx_v_max_dist = 0;
  PyObject *__pyx_v_outlier_cost = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("correspond_pixels (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_img0,&__pyx_n_s_img1,&__pyx_n_s_max_dist,&__pyx_n_s_outlier_cost,0};
    PyObject* values[4] = {0,0,0,0};
    values[2] = ((PyObject *)__pyx_float_0_0075);
    values[3] = ((PyObject *)__pyx_float_100_0);
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img0)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("correspond_pixels", 0, 2, 4, 1); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
        ...
        case  3:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_outlier_cost);
          if (value) { values[3] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "correspond_pixels") < 0)) __PYX_ERR(0, 56, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_img0 = values[0];
    __pyx_v_img1 = values[1];
    __pyx_v_max_dist = values[2];
    __pyx_v_outlier_cost = values[3];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("correspond_pixels", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 56, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("bsds.correspond_pixels.correspond_pixels", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4bsds_17correspond_pixels_correspond_pixels(__pyx_self, __pyx_v_img0, __pyx_v_img1, __pyx_v_max_dist, __pyx_v_outlier_cost);
...
static PyObject *__pyx_pf_4bsds_17correspond_pixels_correspond_pixels(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_img0, PyObject *__pyx_v_img1, PyObject *__pyx_v_max_dist, PyObject *__pyx_v_outlier_cost) {
  ...
  __Pyx_RefNannySetupContext("correspond_pixels", 0);
  __Pyx_INCREF(__pyx_v_max_dist);
  __Pyx_INCREF(__pyx_v_outlier_cost);

  /* "bsds/correspond_pixels.pyx":57
 * 
 * def correspond_pixels(img0, img1, max_dist=0.0075, outlier_cost=100.0):
 *     if img0.shape != img1.shape:             # <<<<<<<<<<<<<<
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 *     if max_dist <= 0.0:
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_img0, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_img1, __pyx_n_s_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyObject_RichCompare(__pyx_t_1, __pyx_t_2, Py_NE); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_img0_shape_and_img1_shape_do_not, __pyx_n_s_format); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_img0, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_img1, __pyx_n_s_shape); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = NULL;
    __pyx_t_7 = 0;
 ...
 *     if outlier_cost <= 1:
 */
  __pyx_t_2 = PyObject_RichCompare(__pyx_v_max_dist, __pyx_float_0_0, Py_LE); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 59, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_4 < 0)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (unlikely(__pyx_t_4)) {

    /* "bsds/correspond_pixels.pyx":60
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 *     if max_dist <= 0.0:
 *         raise ValueError('max_dist must be >= 0 (it is {})'.format(max_dist))             # <<<<<<<<<<<<<<
 *     if outlier_cost <= 1:
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_max_dist_must_be_0_it_is, __pyx_n_s_format); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_8 = NULL;
    ...
    if (!__pyx_t_8) {
      __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_v_max_dist); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 60, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_3)) {
        PyObject *__pyx_temp[2] = {__pyx_t_8, __pyx_v_max_dist};
      ...
      #endif
      {
        ...
        PyTuple_SET_ITEM(__pyx_t_5, 0+1, __pyx_v_max_dist);
    ...
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_builtin_ValueError, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
 */
  __pyx_t_3 = PyObject_RichCompare(__pyx_v_outlier_cost, __pyx_int_1, Py_LE); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 61, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_4 < 0)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (unlikely(__pyx_t_4)) {

    /* "bsds/correspond_pixels.pyx":62
 *         raise ValueError('max_dist must be >= 0 (it is {})'.format(max_dist))
 *     if outlier_cost <= 1:
 *         raise ValueError('outlier_cost must be > 1 (it is {})'.format(max_dist))             # <<<<<<<<<<<<<<
 * 
 * 
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_outlier_cost_must_be_1_it_is, __pyx_n_s_format); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_5 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    ...
    if (!__pyx_t_5) {
      __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_v_max_dist); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 62, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_2)) {
        PyObject *__pyx_temp[2] = {__pyx_t_5, __pyx_v_max_dist};
        __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_2, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 62, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_2)) {
        PyObject *__pyx_temp[2] = {__pyx_t_5, __pyx_v_max_dist};
        __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_2, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 62, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
        __Pyx_GOTREF(__pyx_t_3);
      } else
      #endif
      {
        ...
        __Pyx_INCREF(__pyx_v_max_dist);
        __Pyx_GIVEREF(__pyx_v_max_dist);
        PyTuple_SET_ITEM(__pyx_t_8, 0+1, __pyx_v_max_dist);
    ...
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_builtin_ValueError, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_img0, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_copy); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 65, __pyx_L1_error)
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_empty_tuple, __pyx_t_3); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_v_img1, __pyx_n_s_astype); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_copy); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 66, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_empty_tuple, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_8);
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 67, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, __pyx_t_8); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_v_i1);
  __pyx_t_2 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 68, __pyx_L1_error)
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  __pyx_t_3 = __Pyx_PyNumber_Float(__pyx_v_max_dist); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF_SET(__pyx_v_max_dist, __pyx_t_3);
  __pyx_t_3 = 0;

  /* "bsds/correspond_pixels.pyx":70
 *     o1 = np.zeros_like(i1, order='F')
 *     max_dist = float(max_dist)
 *     outlier_cost = float(outlier_cost)             # <<<<<<<<<<<<<<
 *     cost, oc = _correspond_pixels(i0, i1, max_dist, outlier_cost, o0, o1)
 ...
 */
  __pyx_t_3 = __Pyx_PyNumber_Float(__pyx_v_outlier_cost); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF_SET(__pyx_v_outlier_cost, __pyx_t_3);
  __pyx_t_3 = 0;

  /* "bsds/correspond_pixels.pyx":71
 *     max_dist = float(max_dist)
 *     outlier_cost = float(outlier_cost)
 *     cost, oc = _correspond_pixels(i0, i1, max_dist, outlier_cost, o0, o1)             # <<<<<<<<<<<<<<
 *     return o0, o1, cost, oc
 */
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dcd__double(__pyx_v_i0, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dcd__double(__pyx_v_i1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_t_11 = __pyx_PyFloat_AsDouble(__pyx_v_max_dist); if (unlikely((__pyx_t_11 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_t_12 = __pyx_PyFloat_AsDouble(__pyx_v_outlier_cost); if (unlikely((__pyx_t_12 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_dcd__double(__pyx_v_o0, PyBUF_WRITABLE); if (unlikely(!__pyx_t_13.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_t_14 = __Pyx_PyObject_to_MemoryviewSlice_dcd__double(__pyx_v_o1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_14.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_t_3 = __pyx_f_4bsds_17correspond_pixels__correspond_pixels(__pyx_t_9, __pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  if ((likely(PyTuple_CheckExact(__pyx_t_3))) || (PyList_CheckExact(__pyx_t_3))) {
    ...
    index = 0; __pyx_t_2 = __pyx_t_15(__pyx_t_8); if (unlikely(!__pyx_t_2)) goto __pyx_L6_unpacking_failed;
    __Pyx_GOTREF(__pyx_t_2);
    index = 1; __pyx_t_5 = __pyx_t_15(__pyx_t_8); if (unlikely(!__pyx_t_5)) goto __pyx_L6_unpacking_failed;
    __Pyx_GOTREF(__pyx_t_5);
    if (__Pyx_IternextUnpackEndCheck(__pyx_t_15(__pyx_t_8), 2) < 0) __PYX_ERR(0, 71, __pyx_L1_error)
    __pyx_t_15 = NULL;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  ...
  __pyx_t_2 = 0;
  __pyx_v_oc = __pyx_t_5;
  __pyx_t_5 = 0;

  /* "bsds/correspond_pixels.pyx":72
 *     outlier_cost = float(outlier_cost)
 *     cost, oc = _correspond_pixels(i0, i1, max_dist, outlier_cost, o0, o1)
 *     return o0, o1, cost, oc             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_INCREF(__pyx_v_o0);
  __Pyx_GIVEREF(__pyx_v_o0);
  PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_v_o0);
  __Pyx_INCREF(__pyx_v_o1);
  __Pyx_GIVEREF(__pyx_v_o1);
  PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_v_o1);
  __Pyx_INCREF(__pyx_v_cost);
  __Pyx_GIVEREF(__pyx_v_cost);
  PyTuple_SET_ITEM(__pyx_t_3, 2, __pyx_v_cost);
  __Pyx_INCREF(__pyx_v_oc);
  __Pyx_GIVEREF(__pyx_v_oc);
  PyTuple_SET_ITEM(__pyx_t_3, 3, __pyx_v_oc);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
 ...
 * 
 */
    __pyx_t_3 = PyList_New(1); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 1472, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
 ...
 *             field += 1
 */
      __pyx_t_3 = __pyx_format_from_typeinfo(__pyx_v_field->type); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 1476, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
      __pyx_t_3 = PyNumber_Add(__pyx_v_part, __pyx_kp_b__26); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 1477, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_5 = __Pyx_PyBytes_FromString(__pyx_v_field->name); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 1477, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = PyNumber_Add(__pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 1477, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Add(__pyx_t_6, __pyx_kp_b__26); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 1477, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = PyNumber_Add(__pyx_t_5, __pyx_kp_b__27); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 1480, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *         else:
 */
      __pyx_t_6 = PyList_New(0); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 1484, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_8 = __pyx_v_type->ndim;
      __pyx_t_9 = __pyx_t_8;
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        __pyx_v_i = __pyx_t_10;
        __pyx_t_5 = __Pyx_PyInt_FromSize_t((__pyx_v_type->arraysize[__pyx_v_i])); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 1484, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_3 = __Pyx_PyObject_Unicode(__pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 1484, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        if (unlikely(__Pyx_ListComp_Append(__pyx_t_6, (PyObject*)__pyx_t_3))) __PYX_ERR(1, 1484, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      }
 ...
 *             result = fmt.string
 */
      __pyx_t_6 = PyUnicode_Join(__pyx_kp_u__28, __pyx_v_extents); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 1485, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_3 = PyUnicode_Format(__pyx_kp_u_s, __pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 1485, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyUnicode_AsASCIIString(((PyObject*)__pyx_t_3)); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 1485, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_PyObject_FromString(__pyx_v_fmt.string); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 1485, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_5 = PyNumber_Add(__pyx_t_6, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 1485, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (!(likely(PyBytes_CheckExact(__pyx_t_5))||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_t_5)->tp_name), 0))) __PYX_ERR(1, 1485, __pyx_L1_error)
 ...
 */
    /*else*/ {
      __pyx_t_5 = __Pyx_PyObject_FromString(__pyx_v_fmt.string); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 1487, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_v_result = ((PyObject*)__pyx_t_5);
      __pyx_t_5 = 0;
    }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "bsds.correspond_pixels.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "bsds.correspond_pixels.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "bsds.correspond_pixels.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "bsds.correspond_pixels._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_correspond_pixels(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_correspond_pixels},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_bsds_correspond_pixels, __pyx_k_bsds_correspond_pixels, sizeof(__pyx_k_bsds_correspond_pixels), 0, 0, 1, 1},
  {&__pyx_kp_s_bsds_correspond_pixels_pyx, __pyx_k_bsds_correspond_pixels_pyx, sizeof(__pyx_k_bsds_correspond_pixels_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_correspond_pixels, __pyx_k_correspond_pixels, sizeof(__pyx_k_correspond_pixels), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_img0, __pyx_k_img0, sizeof(__pyx_k_img0), 0, 0, 1, 1},
  {&__pyx_kp_s_img0_shape_and_img1_shape_do_not, __pyx_k_img0_shape_and_img1_shape_do_not, sizeof(__pyx_k_img0_shape_and_img1_shape_do_not), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_max_dist_must_be_0_it_is, __pyx_k_max_dist_must_be_0_it_is, sizeof(__pyx_k_max_dist_must_be_0_it_is), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_o0, __pyx_k_o0, sizeof(__pyx_k_o0), 0, 0, 1, 1},
  {&__pyx_n_s_o1, __pyx_k_o1, sizeof(__pyx_k_o1), 0, 0, 1, 1},
  {&__pyx_n_s_obj, __pyx_k_obj, sizeof(__pyx_k_obj), 0, 0, 1, 1},
  {&__pyx_n_s_oc, __pyx_k_oc, sizeof(__pyx_k_oc), 0, 0, 1, 1},
  {&__pyx_n_s_order, __pyx_k_order, sizeof(__pyx_k_order), 0, 0, 1, 1},
  {&__pyx_n_s_outlier_cost, __pyx_k_outlier_cost, sizeof(__pyx_k_outlier_cost), 0, 0, 1, 1},
  {&__pyx_kp_s_outlier_cost_must_be_1_it_is, __pyx_k_outlier_cost_must_be_1_it_is, sizeof(__pyx_k_outlier_cost_must_be_1_it_is), 0, 0, 1, 0},
 ...
 *     o0 = np.zeros_like(i0, order='F')
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_n_s_float64); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 65, __pyx_L1_error)
 ...
 *     o1 = np.zeros_like(i1, order='F')
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_n_s_float64); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 66, __pyx_L1_error)
 ...
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 */
  __pyx_tuple__29 = PyTuple_Pack(10, __pyx_n_s_img0, __pyx_n_s_img1, __pyx_n_s_max_dist, __pyx_n_s_outlier_cost, __pyx_n_s_i0, __pyx_n_s_i1, __pyx_n_s_o0, __pyx_n_s_o1, __pyx_n_s_cost, __pyx_n_s_oc); if (unlikely(!__pyx_tuple__29)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__29);
  __Pyx_GIVEREF(__pyx_tuple__29);
  __pyx_codeobj__30 = (PyObject*)__Pyx_PyCode_New(4, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__29, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_bsds_correspond_pixels_pyx, __pyx_n_s_correspond_pixels, 56, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__30)) __PYX_ERR(0, 56, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcorrespond_pixels(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcorrespond_pixels(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_correspond_pixels(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_correspond_pixels(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_correspond_pixels(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_correspond_pixels(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("correspond_pixels", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_bsds__correspond_pixels) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bsds.correspond_pixels")) {
      if (unlikely(PyDict_SetItemString(modules, "bsds.correspond_pixels", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         raise ValueError('img0.shape ({}) and img1.shape({}) do not match'.format(img0.shape, img1.shape))
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4bsds_17correspond_pixels_1correspond_pixels, NULL, __pyx_n_s_bsds_correspond_pixels); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_correspond_pixels, __pyx_t_1) < 0) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "bsds/correspond_pixels.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bsds.correspond_pixels", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bsds.correspond_pixels");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
