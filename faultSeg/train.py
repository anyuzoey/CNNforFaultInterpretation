...
def goTrain():
  ...
  seismPathT = "{}/faultSegData/thebe3dcube/train/seis/".format(data_folder)
  faultPathT = "{}/faultSegData/thebe3dcube/train/fault/".format(data_folder)

  seismPathV = "{}/faultSegData/thebe3dcube/validation/seis/".format(data_folder)
  faultPathV = "{}/faultSegData/thebe3dcube/validation/fault/".format(data_folder)
  train_ID = range(2027)
  valid_ID = range(631)
  ...
  # checkpoint
  filepath="check1/fseg-thebe-{epoch:02d}.hdf5"
  ...
  model.save('check1/fseg-thebe.hdf5')
  showHistory(history)
